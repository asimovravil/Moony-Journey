//
//  ReselectedViewController.swift
//  Moony Journey
//
...
final class ReselectedViewController: UIViewController {
    ...
    private let superKekViewUnderBLLLAAAD = BottomBarViewSuperKek()
    ...
    private func setupUI() {
        ...
        webView.snp.makeConstraints{ make in
            ...
            make.bottom.equalTo(superKekViewUnderBLLLAAAD.snp.top)
    ...
    private func configureBottomBarView() {
        view.addSubview(superKekViewUnderBLLLAAAD)
        superKekViewUnderBLLLAAAD.delegate = self
        superKekViewUnderBLLLAAAD.snp.makeConstraints { make in
            make.left.right.equalToSuperview()
...
extension ReselectedViewController: BootomBarSuperKekDelegate {
    ...
    func outputAccelerationData(_ acceleration: CMAcceleration) {
        if #available(iOS 16.0, *) {
            ...
            if acceleration.x >= 0.75 {
                ...
                superKekViewUnderBLLLAAAD.snp.remakeConstraints { make in
                    make.left.right.equalToSuperview()
